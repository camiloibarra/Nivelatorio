...
hay que cargar tidyvverse, porque la funcon filtro esta en varios paquetesY POR DEFECTO SE USA EL DEL PAQUETE STATS
...
#View(dplyr::filter(flights,  carrier == "B6" & distance <= 1500))
# --------------------------- #
})
```
