...
```{R ejercicioFactor1}
# 1 linea de código
PatientStatus<-c("poor","improved","excellent","poor","improved","excellent","poor","improved","excellent")
pfactor<-factor(PatientStatus, levels=c("poor","improved","excellent"))
# -------------------
PatientStatus
```
...
R/un missing es vacio, vacio no factor
...
factorx<-factor(x, levels=c(11,22,47), ordered=TRUE)
factorx
x[4]
...
```{R listExample2}
mylist[[2]]
mylist[[3]][1,] #retorna la matric e imprime la primera fila de la matriz (posicion3) dentro de la lista
mylist[["ages"]]
```
